...
const Borrando_registro_enfermedades_usuarios = (props) =>{
    ...
    return(
        <div>
            ...
            <div className='pregunta_borrado'>
                ...
                <div className='mb'>Usuario {props.registroSeleccionado.registro.UsuarioID} - Enfermedad {props.registroSeleccionado.registro.EnfermedadID}</div>
...
}))(Borrando_registro_enfermedades_usuarios);